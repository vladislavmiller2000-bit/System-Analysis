...
Seeking a system or business analyst position with opportunities for professional growth. Open to internships or entry-level roles with mentorship.
...
| Area | Skills |
|---|---|
| Analysis & Modeling | BPMN 2.0, UML (Use Case, State Machine, Activity), ERD (Chen, Crow's Foot) |
| Data & SQL | SQL (JOIN, subqueries, CTEs, window functions, aggregation), normalization (1NF–3NF) |
| Tools | Power BI, MS Excel (pivot tables, formulas, charts), Miro, Draw.io, Figma |
| Documentation | Requirements gathering & documentation, SRS, data dictionary, Use Case specifications |
| Methodologies | Agile/Scrum (fundamentals), Waterfall, AS-IS/TO-BE analysis |
...
**Yandex Practicum — Systems Analyst** | 2025 – 2026  
Requirements analysis, UML, BPMN, data modeling, SQL, Power BI, collaboration with development and QA teams.

---

## LANGUAGES

Russian (native) | English (fluent) | Spanish (basic) | Hebrew (basic)
