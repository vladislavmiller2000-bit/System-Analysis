...
**Ключевые артефакты:**
[User Story Map + MVP (Чекап)](vita_clinic_project/checkup/) · [User Story Map (MD)](vita_clinic_project/checkup/01_user_story_map_checkup.md) · [MVP (MD)](vita_clinic_project/checkup/02_mvp_selection_checkup.md)
